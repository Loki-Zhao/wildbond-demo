    ...
    ? [
        {
          ...
          points: [
            ...
            "ペットを Lv10 まで育てると、同じ段階の2体で次の段階へ合成できます。",
        ...
        },
        {
          ...
          points: [
            "キャンプ付近は初級の低レベル敵が中心です。",
            "地図の中盤以降は敵レベルが上がり、中級が混ざり始めます。",
            "野外では高級と神獣は出現しません。高級以上は主に合成と首領戦で登場します。",
        ...
        },
        {
          ...
          points: [
            ...
            "捕獲は敵のHPが低いほど成功しやすく、段階や個体Lvが高いほど難しくなります。"
          ]
        },
        {
          id: "growth",
          ...
          points: [
            ...
            "弱小、普通、希少の品質があり、基礎能力が約90%、100%、110%になります。",
            "野生ペットは希少10%、普通50%、弱小40%で出現します。",
            "初級 Lv10 同士で中級へ、中級 Lv10 同士で高級へ進みます。",
            "合成成功率は初級から中級が80%、中級から高級が50%です。",
            "同属性の異なる高級 Lv10 を2体そろえると、30%で同属性の神獣へ合成できます。",
            "合成に失敗すると素材2体は消え、素材どちらか1体の Lv1 ペットが残ります。",
            "同属性同士の合成は同属性の次段階、異属性同士は次段階の全体プールからランダムです。",
            "高級は分解結晶で +1 から +3 まで強化できます。成功率は +1 が80%、+2 が50%、+3 が30%です。",
        ...
        },
        {
          id: "boss",
          title: "首領の準備",
          summary: "首領は捕獲できず、同じ地図属性の神獣1体と高級2体で現れます。",
          points: [
            "挑む前にキャンプで回復し、3体の出撃枠を埋めておくと安全です。",
            "普通の首領は高級 Lv10 の3体編成で突破可能な難度です。",
            "神獣がいると普通の首領は楽になり、首領強化挑戦に挑みやすくなります。",
    ...
    : [
        {
          ...
          points: [
            ...
            "宠物练到个体 Lv10 后，可以和同阶段的另一只 Lv10 宠物合成到下一阶段。",
        ...
        },
        {
          ...
          points: [
            "营地周边主要出现低等级初级宠物，适合开局练级和捕获。",
            "地图中段以后敌人等级会上升，并开始混入中级宠物。",
            "野外不会出现高级和神兽，高级以上主要依靠合成与首领战展示。",
        ...
        },
        {
          ...
          points: [
            ...
            "捕获成功率受敌方HP、阶段、个体Lv影响；HP越低越容易捕获。"
          ]
        },
        {
          id: "growth",
          ...
          points: [
            ...
            "宠物有弱小、普通、稀有三种品质，基础属性约为90%、100%、110%。",
            "野外遇敌品质概率为：稀有10%、普通50%、弱小40%。",
            "初级 Lv10 两两合成中级；中级 Lv10 两两合成高级。",
            "合成成功率为：初级到中级80%，中级到高级50%。",
            "同属性两只不同高级 Lv10 可以用30%概率合成同属性神兽。",
            "合成失败时，两只材料会消失，并留下材料中随机一只的 Lv1 个体。",
            "同属性合成会进入同属性下一阶段，异属性合成会从下一阶段全池随机。",
            "高级宠物可以使用分解水晶强化到 +1、+2、+3；成功率分别是80%、50%、30%。",
        ...
        },
        {
          id: "boss",
          title: "首领准备",
          summary: "首领不可捕获，会以当前地图属性的1只神兽和2只高级宠物出现。",
          points: [
            "挑战前先在营地恢复，并尽量凑满3只出战宠物。",
            "普通首领以3只高级 Lv10 宠物为推荐挑战线，会有压力但可通过策略战胜。",
            "获得神兽后普通首领会明显轻松，神兽主要用于后续强化挑战。",
